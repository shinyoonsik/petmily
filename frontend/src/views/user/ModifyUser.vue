 ...
 //성별이 변경되었는지 체크
      ...
      return new Promise((resolve, reject) => {
        ...
        .then(({data}) => {
          if(data === "SUCCESS"){
            ...
            console.log(this.userId + "회원탈퇴 지워지나요~~~~~~~~~~~~")
    ...
    deleteFeedalert: function(user_id){
      return new Promise((resolve, reject) => {
        ...
        .then(({data}) => {
          console.log(this.userId + "피드 알람 지워지나요~~~~~~~~~~~~")
          resolve(this.userId);  // this.userId
        }).catch((e) => {
    ...
    deleteFollowalert: function(user_id){
      return new Promise((resolve, reject) => {
        ...
        .then(({data}) => {
          console.log(this.userId + "팔로우 알람 지워지나요~~~~~~~~~~~~")
          resolve(this.userId)  // this.userId
        }).catch((e) => {
    ...
    deleteFollow: function(user_id){
      return new Promise((resolve, reject) => {
        ...
        .then(({data}) => {
          console.log(this.userId + "팔로우 정보 지워지나요~~~~~~~~~~~~")
          resolve(this.userId)  // this.userId
        }).catch((e) => {
    ...
    deleteFeed: function(user_id){
      return new Promise((resolve, reject) => {
        ...
        .then(({data}) =>{
          console.log(this.userId + "탈퇴회원 피드 정보 지워지나요~~~~~~~~~")
          resolve(this.userId)
        }).catch((e) =>{
    ...
    deleteFile: function(user_id){
      return new Promise((resolve, reject) => {
        ...
        .then(({data}) => {
          console.log(this.userId + "탈퇴회원 모든 파일정보 지워지나요~~~~~~")
          resolve(this.userId)
        }).catch((e) => {
    ...
    deleteFriendTag: function(user_id){
      return new Promise((resolve, reject) => {
        ...
        .then(({data}) => {
          console.log(this.userId + "탈퇴회원 친구정보 지워지나요~~~~~~")
          resolve(this.userId)
        }).catch((e) => {
    ...
    deleteBackground: function(user_id){
      return new Promise((resolve, reject) => {
        ...
        .then(({data}) => {
          console.log(this.userId + "탈퇴회원 다이어리 배경이미지 지워지나요~~~~~~")
          resolve(this.userId)
        }).catch((e) => {
    ...
    deleteDiary: function(user_id){
      return new Promise((resolve, reject) => {
        ...
        .then(({data}) => {
          console.log(this.userId + "탈퇴회원 다이어리 지워지나요~~~~~~")
          resolve(this.userId)
        }).catch((e) => {
    ...
    deleteDiaryfile: function(user_id){
      return new Promise((resolve, reject) => {
        ...
        .then(({data}) => {
          console.log(this.userId + "탈퇴회원 다이어리파일 지워지나요~~~~~~")
          resolve(this.userId)
        }).catch((e) => {
    ...
    deleteDiarypettag: function(user_id){
       return new Promise((resolve, reject) => {
        ...
        .then(({data}) => {
          console.log(this.userId + "탈퇴회원 펫태그 지워지나요~~~~~~")
          resolve(this.userId)
        }).catch((e) => {
    ...
    deleteLikely: function(user_id){
      return new Promise((resolve, reject) => {
        ...
        .then(({data}) => {
          console.log(this.userId + "탈퇴회원 좋아요 지워지나요~~~~~~")
          resolve(this.userId)
        }).catch((e) => {
    ...
    deleteMemo: function(user_id){
      return new Promise((resolve, reject) => {
        ...
        .then(({data}) => {
          console.log(this.userId + "탈퇴회원 댓글 지워지나요~~~~~~")
          resolve(this.userId)
        }).catch((e) => {
    ...
    deletePet: function(user_id){
      return new Promise((resolve, reject) => {
        ...
        .then(({data}) => {
          console.log(this.userId + "탈퇴회원 펫정보 지워지나요~~~~~~")
          resolve(this.userId)
        }).catch((e) => {
    ...
    deleteRoom: function(user_id){
      return new Promise((resolve, reject) => {
        ...
        .then(({data}) => {
          console.log(this.userId + "탈퇴회원 room 지워지나요~~~~~~")
          resolve(this.userId)
        }).catch((e) => {
    ...
    deleteChat: function(user_id){
      return new Promise((resolve, reject) => {
        ...
        .then(({data}) => {
          console.log(this.userId + "탈퇴회원 chat 지워지나요~~~~~~")
          resolve(this.userId)
        }).catch((e) => {
    ...
    deleteRecentchat: function(user_id){
      return new Promise((resolve, reject) => {
        ...
        .then(({data}) => {
          console.log(this.userId + "탈퇴회원 recentchat 지워지나요~~~~~~")
          resolve(this.userId)
        }).catch((e) => {
    ...
    deletePettag: function(){
      return new Promise((resolve, reject) => {
        ...
        .then(({data}) => {
          console.log(this.userId + "탈퇴회원 pettag 지워지나요~~~~~~")
          resolve()
        }).catch((e) => {
    ...
    deleteTag:function(){
      return new Promise((resolve, reject) => {
        ...
        .then(({data}) => {
          console.log(this.userId + "탈퇴회원 tag 지워지나요~~~~~~")
          resolve()
        }).catch((e) => {
