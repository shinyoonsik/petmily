...
VALUES ('ssafy1@naver.com', '싸피1', 'ssafyssafy1', '김싸피' ,'안녕하세요 김싸피입니다','1995-01-01', 'W', 'Y');

INSERT INTO member (user_email, user_nickname, user_password, user_name, user_content,user_birth, user_gender, certified)
VALUES ('ssafy2@naver.com', '싸피2', 'ssafyssafy1', '신싸피' ,'안녕하세요 신싸피입니다','1995-01-01', 'W', 'Y');

INSERT INTO member (user_email, user_nickname, user_password, user_name, user_content,user_birth, user_gender, certified)
VALUES ('ssafy3@naver.com', '싸피3', 'ssafyssafy1', '박싸피' ,'안녕하세요 박싸파입니다','1995-01-01', 'M', 'Y');

INSERT INTO member (user_email, user_nickname, user_password, user_name, user_content,user_birth, user_gender, certified)
VALUES ('ssafy4@naver.com', '싸피4', 'ssafyssafy1', '이싸피' ,'안녕하세요 이싸피입니다','1995-01-01', 'M', 'Y');
...
-- 게시물 관련 알람
DROP TABLE IF EXISTS `feedalert`;
CREATE TABLE `feedalert` (
   `alert_id` int NOT NULL AUTO_INCREMENT,
   `alert_to` int,
   `alert_kind` int DEFAULT NULL, -- 1이면 친구태그관련, 2면 댓글관련 알람
   `from_id` int,
   `from_nickname` varchar(20),
   `alert_content` varchar(200),
   `feed_id` int,
  `feed_content` varchar(500) DEFAULT null,
  `memo_id` int,
  `comment` VARCHAR(500) NULL,
 ...
 -- 팔로우 관련 알람
 DROP TABLE IF EXISTS `followalert`;
CREATE TABLE `followalert` (
   `alert_id` int NOT NULL AUTO_INCREMENT,
   `alert_to` int,
   `from_id` int,
   `from_nickname` varchar(20),
